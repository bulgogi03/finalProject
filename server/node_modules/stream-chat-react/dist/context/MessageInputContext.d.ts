...
export declare const MessageInputContext: React.Context<(MessageInputState<DefaultStreamChatGenerics> & import("../components/MessageInput/hooks/useLinkPreviews").EnrichURLsController & {
    ...
    recordingController: import("..").RecordingController;
    removeAttachment: (id: string) => void;
    removeFile: (id: string) => void;
    removeImage: (id: string) => void;
    textareaRef: React.MutableRefObject<HTMLTextAreaElement | null | undefined>;
    uploadAttachment: (attachment: import("../components/MessageInput").LocalAttachment<DefaultStreamChatGenerics>) => Promise<import("../components/MessageInput").LocalAttachment<DefaultStreamChatGenerics>>;
